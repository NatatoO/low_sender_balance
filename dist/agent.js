...
var handleTransaction = function (txEvent) { return __awaiter(void 0, void 0, void 0, function () {
    var findings, contract, balance, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                findings = [];
                if (!txEvent.to) return [3 /*break*/, 5];
                contract = new web3.eth.Contract(abi, txEvent.to);
                balance = void 0;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, contract.methods.balanceOf(txEvent.from).call()];
            case 2:
                balance = _b.sent();
                return [3 /*break*/, 4];
            case 3:
